...
/*
    { "name": "vaip_pass_dd_merge_qconv2matmul_6",
       "plugin": "vaip-pass_dd_merge_qconv2matmul_6",
       "disabled": false
    }
*/
namespace {
...
struct Dd_merge_qconv2matmul_6 {

  Dd_merge_qconv2matmul_6(IPass& self) : self_{self} {}
  std::unique_ptr<Rule> create_rule(IPass* self) {
    auto conv2matmul = vaip::pattern_zoo::get_pattern("m_qconv2matmul_6");
    // std::cout << "Reached the qconv2matmul_6 pass" << std::endl;
    ...
    return Rule::create_rule(
        ...
        conv2matmul, [=](onnxruntime::Graph* graph, binder_t& binder) -> bool {
          ...
          //   bool no_op_in_parent = qconv2matmul::check_no_op_child(*graph,
          //   out_node.node,
          //                                            no_op_node_arg,
          //                                            "Squeeze");
          //   if (no_op_in_parent) {
          ...
          if (weight_data_type == 2) {
            ...
            NodeBuilder(*graph, *self)
                ...
                .add("input_format", "NCHW")
                .add("design_param", "4x4PSU")
                .add("q_scale", out_scale)
                .add("q_zp", (int64_t)out_zero_point)
                .add("in_dtypes", input_types)
                .add("out_dtypes", output_types)
                .add("orig_output_shape", *out_shape)
                .add("input_q_params", input_q_params)
...
DEFINE_VAIP_PASS(Dd_merge_qconv2matmul_6, vaip_pass_dd_merge_qconv2matmul_6)
