...
struct MergeIConv_1 {
  MergeIConv_1(IPass& self) : self_{self} {}

  static std::unique_ptr<Rule> create_rule_1(IPass* self) {

    auto ms_QuantizeLinear_29 = vaip::pattern_zoo::get_pattern("m_iconv_1");
    ...
    return Rule::create_rule(
        ...
        [=](onnxruntime::Graph* graph, binder_t& binder) -> bool {
          ...
          auto transpose_node_0 = binder["Transpose_8"];
          auto transpose_node_1 = binder["Transpose_24"];
          auto reshape_node_1 = binder["Reshape_28"];
  ...
  void process(IPass& self, Graph& graph) {
    MY_LOG(1) << "try matching IConv pattern 1";
    create_rule_1(&self)->apply(&graph);
  }
...
DEFINE_VAIP_PASS(MergeIConv_1, vaip_pass_dd_merge_iconv_1)
