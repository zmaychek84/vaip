...
DEF_ENV_PARAM(DEBUG_DD_MERGE_DEQUANT, "0")
#define MY_LOG(n) LOG_IF(INFO, ENV_PARAM(DEBUG_DD_MERGE_DEQUANT) >= n)
...
/*
    { "name": "vaip_pass_dd_merge_dequant",
       "plugin": "vaip-pass_dd_merge_dequant",
       "disabled": false
    }
*/
namespace {
using namespace vaip_core;
struct Dd_merge_dequant {
  Dd_merge_dequant(IPass& self) : self_{self} {}
    ...
    return Rule::create_rule(
        dq, [=](onnxruntime::Graph* graph, binder_t& binder) -> bool {
          ...
          NodeBuilder(*graph, *self)
              ...
              .set_op_type("DeQuantOP", "com.xilinx")
              .add("nodes", ns)
...
DEFINE_VAIP_PASS(Dd_merge_dequant, vaip_pass_dd_merge_dequant)
