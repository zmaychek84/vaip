...
struct MergeFlatMLP {
  MergeFlatMLP(IPass& self) : self_{self} {}
  ...
  static std::unique_ptr<Rule> create_rule(IPass* self) {
    auto result = vaip::pattern_zoo::get_pattern("FlatMLP");
    ...
    return Rule::create_rule(
        result, [=](onnxruntime::Graph* graph, binder_t& binder) -> bool {
          ...
          auto flat_mlp_node =
              binder["/model/layers.31/mlp/Mul_2_output_0_QuantizeLinear"];
          ...
          auto out_matmul_node =
              binder["/model/layers.31/mlp/gate_up_proj/"
                     "MatMul_output_0nchw_QuantizeLinear_Output"];
          ...
          auto out_matmul_sc_node1 = binder
              ["/model/layers.31/mlp/gate_up_proj/MatMul_output_0nchw_scale"];
          ...
          //           w_zp_silu, w_shape2, bias, 0.0f, 0, out_sc_mm,
          //           out_zp_mm);
          ...
          auto slice_node =
              binder["/model/layers.31/mlp/Slice_1_output_0_QuantizeLinear"];
          ...
          //       vaip::dd::qmatmulcalc::calc_lrn_coeff(mul_in1_sc,
          //       mul_in1_zp);
          auto [mul_in1_sc_q, mul_in1_zp_q] =
...
DEFINE_VAIP_PASS(MergeFlatMLP, vaip_pass_dd_merge_flatmlp)