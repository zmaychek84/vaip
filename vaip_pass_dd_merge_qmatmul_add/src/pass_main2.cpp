...
struct MergeQMatMulAdd2 {
  MergeQMatMulAdd2(IPass& self) : self_{self} {}
  ...
  static std::unique_ptr<Rule> create_rule(IPass* self) {
    ...
    auto q2 = vaip::pattern_zoo::get_pattern("m_qmatmul_add_1");
    ...
    return Rule::create_rule(
        q2, [=](onnxruntime::Graph* graph, binder_t& binder) -> bool {
          ...
          MY_LOG(1) << "QMATMULADD VARIANT 2 " << node_name;
...
DEFINE_VAIP_PASS(MergeQMatMulAdd2, vaip_pass_dd_merge_qmatmul_add2)
