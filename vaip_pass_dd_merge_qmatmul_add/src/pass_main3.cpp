...
struct MergeQMatMulAdd3 {
  MergeQMatMulAdd3(IPass& self) : self_{self} {}
  ...
  static std::unique_ptr<Rule> create_rule(IPass* self) {
    ...
    auto q3 = vaip::pattern_zoo::get_pattern("m_qmatmul_add_2");
...
DEFINE_VAIP_PASS(MergeQMatMulAdd3, vaip_pass_dd_merge_qmatmul_add3)
