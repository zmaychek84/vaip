...
static vaip_core::ExecutionProvider* create_execution_provider_imp(
  ...
  return new vaip_core::ExecutionProviderImp<
      vaip_resize_norm_custom_op::MyCustomOp>(context, meta_def);
}
...
static vitis::ai::StaticPluginRegister
    __register("vaip_custom_op_ResizeNorm", "create_execution_provider",
               (void*)&create_execution_provider_imp);
} // namespace
extern "C" {
void* vaip_custom_op_resize_norm__hook = &__register;
}
#else
...
extern "C" {
void* vaip_custom_op_resize_norm__hook = nullptr;
}
#endif
