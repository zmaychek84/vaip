...
struct MergeQMatMulAddGelu2 {
  MergeQMatMulAddGelu2(IPass& self) : self_{self} {}
  ...
  static std::unique_ptr<Rule> create_rule(IPass* self) {
    ...
    auto q3 = vaip::pattern_zoo::get_pattern("m_qmatmul_add_gelu_1");
    ...
    return Rule::create_rule(
        q3, [=](onnxruntime::Graph* graph, binder_t& binder) -> bool {
          ...
          MY_LOG(1) << "QMATMULADDGELU VARIANT 2 " << node_name;
...
DEFINE_VAIP_PASS(MergeQMatMulAddGelu2, vaip_pass_dd_merge_qmatmul_add_gelu2)
